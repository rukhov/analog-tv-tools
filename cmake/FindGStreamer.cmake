...
function(FIND_GSTREAMER)
    ...
    file(GLOB_RECURSE GSTREAMER_LIBS_DIR ${CMAKE_CURRENT_BINARY_DIR}/*/libgstbase-?.?.a)
    ...
    file(GLOB_RECURSE GSTREAMER_INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR}/*/gst.h NO_CACHE)
    ...
    file(GLOB_RECURSE GLIB_INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR}/*/glib.h NO_CACHE)
    ...
    file(GLOB_RECURSE GLIB_INCLUDE_DIR2 ${CMAKE_CURRENT_BINARY_DIR}/*/glibconfig.h )
    ...
    file(GLOB_RECURSE GSTREAMER_LIBS_DIR ${CMAKE_CURRENT_BINARY_DIR}/*/libgstreamer-?.?.a )
    list(GET GSTREAMER_LIBS_DIR -1 GSTREAMER_LIBS_DIR)
    cmake_path(GET GSTREAMER_LIBS_DIR PARENT_PATH GSTREAMER_LIBS_DIR)
    message("===========> !GSTREAMER_LIBS_DIR: " ${GSTREAMER_LIBS_DIR})
